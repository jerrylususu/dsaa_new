...
//            node.size = getSize(node.l)+getSize(node.r)+1;
//            return n;
//        }
//
//        if (q == node.val) {
...
//        } else if (getSize(node.l)+cnt+1<k){
//            // go to right
//            return findKth(k,node.r,cnt+getSize(node.l)+1);
//        } else {
//            // this is the node
//            return node;
//        }
...
//
//        // adjust size
//        k2.size = getSize(k2.l)+getSize(k2.r)+1;
//        k1.size = getSize(k1.l)+getSize(k1.r)+1;
//
...
//        // adjust size
//        k1.size = getSize(k1.l)+getSize(k1.r)+1;
//        k3.size = getSize(k3.l)+getSize(k3.r)+1;
//        k2.size = getSize(k2.l)+getSize(k2.r)+1;
//
//
//        return k2;
