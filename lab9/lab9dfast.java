...
// possible reason: not connecting parts
// unable to reach full node
    ...
    static class Task {
        ...
        public void solve(InputReader in2, PrintWriter out) throws IOException {
            ...
            while(totalnum-->0){
                ...
                LinkedList<MyEdge> build = new LinkedList<>();
